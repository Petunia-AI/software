      ...
      >
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between px-4 md:px-8 py-4 md:py-6 gap-3 md:gap-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-white/25 backdrop-blur-sm flex items-center justify-center flex-shrink-0" style={{ boxShadow: "0 2px 16px rgba(0,0,0,0.18), inset 0 1px 0 rgba(255,255,255,0.3)" }}>
            ...
            <div>
              ...
              <h1 className="text-2xl md:text-3xl font-black text-white" style={{ textShadow: "0 1px 8px rgba(0,0,0,0.18)" }}>Agentes de IA</h1>
